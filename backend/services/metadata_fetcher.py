...
from backend.repositories.paper import PaperRepository
from backend.schemas.arxiv.paper import ArxivPaper, PaperCreate
from backend.schemas.pdf_parser.models import ArxivMetadata, ParsedPaper, PdfContent
