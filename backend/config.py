...
class Settings(BaseConfigSettings):
    ...
    # ---------- LLM providers ----------
    # "ollama" (local) or "openai" (remote). When set to "auto" (default) the
    # platform uses OpenAI if OPENAI_API_KEY is present, otherwise Ollama.
    ...
    # compatible gateway such as Groq, Together, OpenRouter, LM Studio, etc).
    openai_api_key: str = ""
