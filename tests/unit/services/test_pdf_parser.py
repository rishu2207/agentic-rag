...
import pytest
from backend.exceptions import PDFParsingException, PDFValidationError
from backend.schemas.pdf_parser.models import PaperSection, ParserType, PdfContent
from backend.services.pdf_parser.docling import DoclingParser
...
class TestPDFParserService:
    ...
    @patch("backend.services.pdf_parser.parser.DoclingParser.parse_pdf")
    @pytest.mark.asyncio
