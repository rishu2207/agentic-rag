...
import httpx
import pytest
from backend.exceptions import ArxivAPIException, ArxivAPITimeoutError, ArxivParseError, PDFDownloadException, PDFDownloadTimeoutError
...
class TestArxivClient:
    ...
    def arxiv_client(self):
        ...
        from backend.config import ArxivSettings
